      ...
      <div className="pt-12 pb-8">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="text-left">
            <h1 className="text-4xl font-bold text-white mb-1">Removedor de Voz con IA</h1>
          ...
          <div className="bg-gray-800 rounded-lg p-8">
            ...
            <div
              className={`border-2 border-dashed rounded-lg p-12 text-center transition-colors cursor-pointer ${
                dragActive ? 'border-purple-400 bg-purple-900/20' : 'border-purple-500'
              }`}
            ...
            >
              <div className="space-y-4">
                ...
                <h3 className="text-white text-xl font-medium">Haz clic para subir</h3>
                <p className="text-gray-400">o arrastra y suelta un archivo aquí</p>
              </div>
              <input
                id="file-input"
                type="file"
